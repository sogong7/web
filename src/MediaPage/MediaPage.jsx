...
export default class MediaPage extends Component {
  ...
  async componentDidMount() {
    ...
    const poster_url = await this._detailPoster();
    this.setState({
      medias: api_detail,
          ...
          <div className="media_page_wrap">
            <div className="media_page clear_float">
              <div className="media_info clear_float" style={{ width: "1080px", margin: "auto" }}>
                ...
                <p>
                  <span className="title">출시년도 : </span>
                  {media.year}
                </p>
                <p>
                  <span className="title">감독 : </span>
                  {media &&
                    media.directors.map((movieStar, index) =>
                ...
                <p>
                  ...
                  {media &&
                    media.genres.map((movieStar, index) =>
                      index == media.genres.length - 1 ? movieStar : movieStar + ", "
                    )}
                </p>
                <p>
                  <span className="title">상영시간 : </span>
                  {media.runtime}분
                </p>
                <p>
